...
public class App {
    ...
    public static long measureTime(String partitionMethod, SortingFunction function, int[] arr) {
        ...
        int trocas;
        if (function instanceof QuickSortLomuto) {
            trocas = ((QuickSortLomuto) function).getTrocas();
        } else {
            trocas = ((QuickSortHoare) function).getTrocas();
        }
    ...
    public static void main(String[] args) {
        ...
        for (int size : sizes) {
            ...
            long hoareTime = measureTime("Hoare", new QuickSortHoare(), subarray);

            // Teste com o método de particionamento de Lomuto
            long lomutoTime = measureTime("Lomuto", new QuickSortLomuto(), subarray);
